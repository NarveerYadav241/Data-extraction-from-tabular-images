...
def main_function(image_dir,head_pos = 0):
    ...
    try:
        ...
        cv2.imshow("line_image",horizontal_image)
        cv2.imshow("vert_image",vertical_image)
        cv2.waitKey(0)
    ...
    if (len(table_ranges)!=0):
        for table_regions in table_ranges:
            ...
            if is_block_image:
                ...
                try:
                    ...
                    non_table_data = without_tables_function(data_crop_image,header_select=head_pos)
        ...
        non_table_data = without_tables_function(image,header_select=head_pos)
        complete_table_data.append(non_table_data)
        return complete_table_data
table_data = main_function("/home/narveeryadav/Downloads/images/image33.png",head_pos=1)
print(table_data)
